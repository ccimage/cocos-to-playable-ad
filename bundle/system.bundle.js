(function () {
  ...
  function resolveImportMap (importMap, resolvedOrPlain, parentUrl) {
    ...
    const ret = applyPackages(resolvedOrPlain, importMap.imports) || resolvedOrPlain.indexOf(':') !== -1 && resolvedOrPlain;
    return ret;
  }
  ...
  function getOrCreateLoad (loader, id, firstParentUrl) {
    ...
    .then(function (registration) {
      ...
      if (typeof registration[1] !== "function") {
        throw new Error("registration[1] is not a function");
      }
  ...
  (function (global) {
    ...
    systemJSPrototype.import = function (id, scriptText) {
      noteGlobalProps();
      return impt.call(this, id, scriptText);
    };
